...
const PolicyPage = () => {
  ...
  const {modalOpen, setModalOpen, setPreferences} = React.useContext(myContext)
  ...
  const handlePolicyChange = () => {
    ...
    setModalOpen(true) // will trigger rerender
      ...
      <Container className={classes.container}>
        <Card className={classes.card}>
          <CardContent>
            ...
            <p>
              erizo-dev-blog ("us", "we", or "our") operates the
              https://erizo-dev.github.io/erizo-dev-blog website (hereinafter
            ...
            <p>
              ...
              for erizo-dev-blog has been created with the help of{" "}
            ...
            <p>
              ...
              https://erizo-dev.github.io/erizo-dev-blog
            </p>
            ...
            <ul>
              <li>
                ...
                <p>
                  Service is the https://erizo-dev.github.io/erizo-dev-blog
                  website operated by erizo-dev-blog
                </p>
              </li>
              <li>
                <p>
            ...
            <p>erizo-dev-blog uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>
              erizo-dev-blog will take all steps reasonably necessary to ensure
            ...
            <p>
              erizo-dev-blog may disclose your Personal Data in the good faith
              belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of erizo-dev-blog
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <p>
                  Google analytics is a web traffic analysis tool. You can read
                ...
                <p>
                  Please note that we have configured google analytics not to
                  collect any personal information, and have anonymized you IP
                  before sending any data to Google.
                </p>
              </li>
            </ul>
            ...
            <ul>
              <li>By mail: erizo-dev-blog -at- erizo -dot- edu</li>
            </ul>
            <h2>Reset your preferences</h2>
            <p>You can always reset your privacy settings clicking</p>
            <Button
